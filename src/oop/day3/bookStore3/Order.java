...
//            System.out.println(book.getTitle().length());
            ...
            for (Book b : basket) {
                ...
                int count = 0;
                for (Book inner : basket) {
                    if (b.getId().equals(inner.getId())) {
                        count++;
                    }
                }
                System.out.println(b.toString() + count + "권 입니다.");
                temp = b.getId();
            }
                // myList.stream().count()
//            System.out.print(book.toString() +"1권" );

//            System.out.print(book.toString() +"책 수량 : "+ ((ArrayList) basket).size() + "권" );
//            System.out.println("==============================");
//        }


//        if (basket.isEmpty()) System.out.println("구매 내역이 없습니다.");
//        System.out.println("==============================");
//        System.out.println(((ArrayList) basket).size());
//        System.out.println(basket.getBookInfo());
//        System.out.println(bookService.getBookList().toString());
//        System.out.println(bookService.getBookInfo().size());
//        System.out.println("==============================");
